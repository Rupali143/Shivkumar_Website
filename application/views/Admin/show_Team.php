    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                ...
                <h4 class="box-title"><a href="<?= base_url() ?>TeamController/add_Team" class="btn btn-primary">Add Team</a></h4>
                            ...
                            <tbody>
                                ...
                                foreach ($mainlist as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo base_url() . $value['team_image']; ?>" width="75px" height="75px"/></td>
                                        <td><?php echo $value['date']; ?></td>
                                        <td><span class="<?= $iconcls ?>"><?php echo $status; ?></span></td>
                                        <td><div style="text-align:center; width:150px;">
                                                <a href="<?= base_url() ?>TeamController/adminchange_status/<?= $value['team_id'] ?>" data-toggle="tooltip" title="status"><button type="button" class="btn btn-primary <?= $iconcls ?>">Status</button></a>
                                                ...
                                                &nbsp;<button type="button" data-toggle="tooltip" title="delete" class="btn btn-primary" onclick="deleteConfirm('<?= $value['team_id'] ?>')">Delete</button>
                                            </div></td>
                                    </tr>
                                <?php } ?>
                        </table>
...
function deleteConfirm($id){
    ...
    if(r ==true){
        window.location = url +"TeamController/deleteTeam/"+$id;
    }else{
        return false;
    }
}

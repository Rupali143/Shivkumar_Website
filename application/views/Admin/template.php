                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" class="p-t-30">
                            <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-dark waves-effect" href="#" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">MainCourosel</span></a>
                                <ul aria-expanded="false" class="collapse  first-level">
                                    ...
                                    <li class="sidebar-item"><a href="form-wizard.html" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> View Main_img </span></a></li>
                                </ul>
                            </li>

    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="box-title"><a href="<?php echo base_url();?>TeamController/add_Team" class="btn btn-primary">Add Team</a></h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php
                    if (empty($geteditid))
                        echo form_open_multipart('TeamController/saveTeam');
                    else
                        echo form_open_multipart('TeamController/editsaveadvertisement/' . $geteditid);
                    ?>                  
                    <?= $form; ?>

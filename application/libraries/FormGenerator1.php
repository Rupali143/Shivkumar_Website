...
//        $this->CI = & get_instance();
        ...
        if ($type == "business" || $type == "business_images" || $type == "users" || $type == "users_info" || $type == "others")
...
//                        }
                        ...
                        if ($db_columns['Field'][$key] == 'profile_img') {
                            $input_type = "file";
                            //$foldername = 'cms';
                        }
                        if ($db_columns['Field'][$key] == 'news_image') {
                            $input_type = "file";
                            //$foldername = 'cms';
                        }
            ...
            foreach ($db_columns['Field'] as $key => $value) {
                foreach ($columns as $key1 => $val) {
                    ...
                    if ($db_columns['Field'][$key] == $val) {
                        ...
                        if ($db_columns['Field'][$key] == 'role_id') {
                            $input_type = "dropdown";
                            $dropdown = $this->form_data['dropdown']['role'];
                        }
                        if ($db_columns['Field'][$key] == 'type_id') {
                            $input_type = "dropdown";
                            $dropdown = $this->form_data['dropdown']['type'];
...
//                            $dropdown = $this->form_data['dropdown']['parentsub'];
                        ...
                        if ($db_columns['Field'][$key] == 'dp_pwd') {
                            $input_type = "password";
                        }
                        if ($db_columns['Field'][$key] == 'dp_profimg') {
                            $input_type = "file";
                            $foldername = 'category';
                        }
//                        if ($db_columns['Field'][$key] == 'carpet_unit_id') {
...
//                            $dropdown = $this->form_data['dropdown']['unit'];
//                        }
                        if ($db_columns['Field'][$key] == "flattype") {
                            $input_type = "dropdownconst";
                            $dropdownconst = unserialize(FLATTYPE);
                        }
//                        if ($db_columns['Field'][$key] == 'domain_id') {
//                            $input_type = "dropdown";
//                            $dropdown = $this->form_data['dropdown']['domain'];
//                        }
//                        if ($db_columns['Field'][$key] == 'prop_age') {
//                            $input_type = "dropdownconst";
//                            $dropdownconst = unserialize(PROPAGE);
//                        }
//                        if ($db_columns['Field'][$key] == "prop_furnishing") {
//                            $input_type = "dropdownconst";
//                            $dropdownconst = unserialize(FURNISHING);
//                        }
//                        if ($db_columns['Field'][$key] == "prop_ownership") {
//                            $input_type = "dropdownconst";
//                            $dropdownconst = unserialize(OWNERSHIP);
//                        }
//                        if ($db_columns['Field'][$key] == 'role_id') {
//                            $input_type = "dropdown";
//                            $dropdown = $this->form_data['dropdown']['role'];
//                        }
//                        if ($db_columns['Field'][$key] == 'user_password') {
//                            $input_type = "password";
//                        }
                        if ($db_columns['Field'][$key] == "oth_card") {
                            $input_type = "radio";
                        ...
                        if ($db_columns['Field'][$key] == "flat_on_rent") {
                            $input_type = "radio";
                            $radioarr = unserialize(RENT);
                        }
                        if ($db_columns['Field'][$key] == 'oth_vdo') {
                            $input_type = "file";
                        }
//                        if ($db_columns['Field'][$key] == "prop_facing") {
//                            $input_type = "dropdownconst";
...
//                        if ($db_columns['Field'][$key] == 'oth_card') {
//                            $input_type = "checkbox";
//                            $checkboxarr = $this->form_data['checkbox']['cards'];
//                        }
//                        if ($db_columns['Field'][$key] == 'flat_on_rent') {
//                            $input_type = "checkbox";
//                            $checkboxarr = $this->form_data['checkbox']['rent'];
//                        }
//                        if (($db_columns['Field'][$key] == "prop_verified") || ($db_columns['Field'][$key] == "proj_verified")) {
//                            $input_type = "radio";
//                            $radioarr = unserialize(VERIFY);
//                        }
                        if ($db_columns['Field'][$key] == 'dpimg_name') {
                            $input_type = "profile_mult_image";
                        }
                        if ($db_columns['Field'][$key] == 'user_password') {
                            $input_type = "password";
                        }
//                        if ($db_columns['Field'][$key] == 'projimage') {
//                            $input_type = "proj_mult_image";
//                        }
                        if ($db_columns['Field'][$key] == 'dp_desc') {
                            $input_type = "editor";
                        }
                        if ($input_type == "text") {
                            if ($validation) {
